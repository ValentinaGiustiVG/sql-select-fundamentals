...
-- Autor: Valentina Giusti
-- Fecha: 17/8/2026
-- ══════════════════════════════════════════

-- Consulta 1: Exploración general de la tabla sales
-- Es útil usar SELECT * al inicio para explorar qué columnas y datos existen, pero no debe usarse en entornos de producción por motivos de rendimiento y transferencia de datos.
SELECT * FROM sales;
